...
public class BattlePauseControl : DefaultUIControl
{
    ...
    {
        if(!isCommandPanelOn && !isControllSetPanelOn && !isSoundOptionPanelOn && !isBackToMenuPanelOn)
        {
    ...
    public override void CheckCommandPanelInput()
    {
                        ...
                        || gameMgr.P2_Right.player.GetAxisRaw("Move Horizontal") > 0) && enableAxisInput)
        {
            ...
            if (is1PCommandView)
            {
                ...
                PlayCommandPanelMov.Insert(0, commandNameP2.transform.DOMoveX(Screen.width / 1.97f, 0.4f));
                PlayCommandPanelMov.Insert(0, commandNameP1.transform.DOMoveX(Screen.width * 1.97f, 0.4f));
